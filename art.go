...
// of allocations. Each element in strides must be a multiple of 8, except for the last entry
// which may be of any length. If using IPv4, strides must sum to 32. Otherwise for IPv6,
// strides must sum to 128. In addition, strides may have at most 16 elements.
//
